  ...
  return (
    <section id="contact" className="bg-[#0f1923] py-24 px-6 section-grid-bg">
      <div className="max-w-7xl mx-auto">
        <div className="mb-14">
          <p className="copper-line text-[10px] tracking-[3px] uppercase text-[#b87333] font-medium mb-3">Visit Us</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-0 divide-y divide-[#b87333]/10">
            {[
              { icon: '📍', label: 'Address', value: settings?.address ?? 'Shop No. XX, [Street Name]\nMumbai — 400 0XX' },
              ...
              <div key={d.label} className="flex gap-4 py-6">
                ...
                <div>
                  <p className="text-[10px] tracking-[2px] uppercase text-[#b87333] font-medium mb-1">{d.label}</p>
                  <p className="text-[#f7f3ec] text-sm leading-relaxed whitespace-pre-line">{d.value}</p>
                </div>
              </div>
            ))}
          ...
          <div className="aspect-[4/3] bg-[#162030] border border-[#b87333]/20 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
            ...
            <p className="text-[11px] tracking-[2px] uppercase text-[#8899aa] relative z-10">Google Maps Embed Here</p>
            <p className="text-xs text-[#8899aa]/60 relative z-10">Add your Google Maps embed URL in Site Settings</p>
          </div>
        </div>
      </div>
    </section>
